...
- In parsed boxes, `uuid` now have an `uuid` hex property instead of a `subtype` property being an Array of numbers.
...
- Add `parseBoxesProgressively` exported function for a non-event-based iterative parser as an hybrid
