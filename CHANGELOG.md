...
- Don't `console.warn` when issues are discovered. Use the new `issues` optional property linked to parsed boxes instead.
...
- Add optional `issues` property to parsed box objects to signal warnings or errors that happened when parsing them
